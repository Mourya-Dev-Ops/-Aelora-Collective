...
export default function Home() {
  return (
    <main className="flex flex-col min-h-screen bg-aelora-bg text-aelora-ivory selection:bg-aelora-gold selection:text-aelora-bg">
      ...
      <section className="py-32 px-6 md:px-12 bg-aelora-bg text-aelora-ivory border-t border-aelora-ivory/10">
        <div className="container mx-auto max-w-5xl text-center">
          <h2 className="font-display text-4xl md:text-7xl lg:text-8xl leading-[1.1] uppercase mb-16">
            ...
            <span className="italic text-aelora-taupe lowercase tracking-normal">We design experiences.</span>
          </h2>
          
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 text-center uppercase tracking-widest text-xs font-medium text-aelora-gold">
            <div className="flex flex-col items-center">
              <span className="text-aelora-ivory/30 mb-2 font-mono">01</span>
              Concept
            </div>
            <div className="flex flex-col items-center">
              <span className="text-aelora-ivory/30 mb-2 font-mono">02</span>
              Design
            </div>
            <div className="flex flex-col items-center">
              <span className="text-aelora-ivory/30 mb-2 font-mono">03</span>
              Production
            </div>
            <div className="flex flex-col items-center">
              <span className="text-aelora-ivory/30 mb-2 font-mono">04</span>
              Experience
            </div>
          </div>
        </div>
      ...
      <section className="py-32 px-6 bg-aelora-ivory text-aelora-bg flex flex-col items-center justify-center text-center">
        <div className="max-w-4xl">
          ...
          <span className="text-xs tracking-widest uppercase font-medium">— Client Name</span>
        </div>
      </section>

      {/* Section 8 - Final CTA */}
      <section className="h-screen w-full flex flex-col items-center justify-center bg-aelora-bg text-aelora-ivory text-center px-6">
        <h2 className="font-display text-6xl md:text-8xl lg:text-9xl uppercase leading-[0.9] mb-12">
          Let's create <br/>
          something <br/>
          <span className="italic text-aelora-taupe lowercase tracking-normal">unforgettable.</span>
        </h2>
        <button className="text-xs md:text-sm tracking-[0.2em] uppercase border-b border-aelora-gold pb-1 hover:text-aelora-gold transition-colors">
